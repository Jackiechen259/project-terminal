 ...
 *
 * Dynamically imported by src/i18n/index.ts only when the active language
 * is zh-CN, so an English session never downloads or parses this file -
 * it was the single largest piece of the app's boot-time JavaScript
 * outside the terminal renderer.
 */

const zhCNSettings: Record<string, string> = {
  Language: "语言",
...
const zhCN: Record<string, string> = { ...zhCNSettings, ...zhCNWorkspace };
